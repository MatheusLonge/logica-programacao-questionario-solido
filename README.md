# Lógica de programação Questionário Sólido
Exercícios resolvidos de lógica de programação — abordando alguns níveis — com exemplos em python
...
2. Crie uma **branch** para sua questão:  
   ```bash
   git checkout -b exercicio-05-tabuada
3. Adicione sua solução e faça commit:
   ```bash
   git add .
   git commit -m "Adiciona solução do exercício 05 - Tabuada"
4. Envie para o Github:
   ```bash
   git push origin exercicio-05-tabuada
